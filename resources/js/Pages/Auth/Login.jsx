        ...
        <>
            ...
            <main className="relative min-h-screen overflow-hidden
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    {/* Dark mode orbs */}
                    <div className="absolute -top-48 -left-48 h-[560px] w-[560px] rounded-full blur-[70px] hidden dark:block animate-float-slow"
                        style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.22) 0%, rgba(5,150,105,0.10) 55%, transparent 75%)', willChange: 'transform' }} />
                    <div className="absolute -bottom-32 -right-32 h-[440px] w-[440px] rounded-full blur-[60px] hidden dark:block"
                        style={{ background: 'radial-gradient(circle, rgba(14,116,144,0.18) 0%, rgba(8,47,73,0.10) 55%, transparent 75%)' }} />
                </div>
                    ...
                    >
                        <form
                            ...
                            className="relative overflow-hidden rounded-2xl p-6 sm:p-8 border
                                ...
                                dark:bg-[#111a15] dark:border-white/[0.07] dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)]"
                        >
                            {/* Decorative corner */}
